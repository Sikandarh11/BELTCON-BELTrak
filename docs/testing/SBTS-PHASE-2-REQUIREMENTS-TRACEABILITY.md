...
| P2-BHS-06      | Al Wajh design extract            | Two-position queue and no overwrite                     | SQLite station inbox                     | P2-STATION-007–010, FAT-SW-003–004 | VERIFIED                                | Physical conveyor timing pending                                 |
...
| P2-DATA-06     | Al Wajh design extract            | Base readiness does not require local image/threat/IATA | `BASE_ALWAJH` database policy            | P2-DB-016, FAT-SW-002/014          | VERIFIED                                | Enhanced policy is explicit opt-in                               |
